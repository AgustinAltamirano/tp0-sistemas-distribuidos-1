...
En la rama `master`, el archivo `README.md` contiene exclusivamente la consigna. Para la explicación y documentación de la solución, se debe consultar el `README.md` de cada una de las ramas correspondientes a los ejercicios resueltos.
